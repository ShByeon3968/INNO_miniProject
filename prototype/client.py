...
def send_message():
    ...
    message = f"M_s={M_s},M_u={M_u},K_s={K_s},K_t={K_t},C={C},sampling_time={sampling_time},total_time={total_time}"
...
def run_gui():
    global entry_ip, entry_M_s, entry_M_u, entry_K_s, entry_K_t, entry_C, entry_sampling_time, entry_total_time
    root = tk.Tk()
    root.title("클라이언트")
